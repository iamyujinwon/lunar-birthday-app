                    ...
                    <div class="w-screen text-center">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div class="text-xl flex flex-col space-y-5">
                                <span>  
                                    <select class="w-[20rem] text-right py-2.5 bg-transparent text-lunar border-solid border-2 border-lunar rounded-xl appearance-none cursor-pointer" onChange={e=>(setInputYear(e.target.value))}>
                                ...
                                <span>
                                    <select class="w-[20rem] text-right py-2.5 bg-transparent text-lunar border-solid border-2 border-lunar rounded-xl appearance-none cursor-pointer" onChange={e=>(setInputMonth(e.target.value))}>
                                ...
                                <span>
                                    <select class="w-[20rem] text-right py-2.5 bg-transparent text-lunar border-solid border-2 border-lunar rounded-xl appearance-none cursor-pointer" onChange={e=>(setInputDay(e.target.value))}>
